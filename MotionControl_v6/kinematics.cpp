...
void Kinematics::run()
{
	...
	poscount_L = telem->get_left_tick();
	poscount_R = telem->get_right_tick();
...
void Kinematics::run()
{
    ...
    float f_delta_tick_L = m_speed_left * m_real_time_period;
    float f_delta_tick_R = m_speed_right * m_real_time_period;
