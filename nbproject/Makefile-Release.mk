...
${OBJECTDIR}/MotionControl_v6/absolute_rotation.o: MotionControl_v6/absolute_rotation.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MotionControl_v6/absolute_rotation.o MotionControl_v6/absolute_rotation.cpp

${OBJECTDIR}/MotionControl_v6/can_interface.o: MotionControl_v6/can_interface.cpp
	${MKDIR} -p ${OBJECTDIR}/MotionControl_v6
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MotionControl_v6/can_interface.o MotionControl_v6/can_interface.cpp

${OBJECTDIR}/MotionControl_v6/circ_rotation.o: MotionControl_v6/circ_rotation.cpp
	${MKDIR} -p ${OBJECTDIR}/MotionControl_v6
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MotionControl_v6/circ_rotation.o MotionControl_v6/circ_rotation.cpp

${OBJECTDIR}/MotionControl_v6/clocking.o: MotionControl_v6/clocking.cpp
	${MKDIR} -p ${OBJECTDIR}/MotionControl_v6
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MotionControl_v6/clocking.o MotionControl_v6/clocking.cpp

${OBJECTDIR}/MotionControl_v6/follow_line.o: MotionControl_v6/follow_line.cpp
	${MKDIR} -p ${OBJECTDIR}/MotionControl_v6
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MotionControl_v6/follow_line.o MotionControl_v6/follow_line.cpp

${OBJECTDIR}/MotionControl_v6/geometry.o: MotionControl_v6/geometry.cpp
	${MKDIR} -p ${OBJECTDIR}/MotionControl_v6
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MotionControl_v6/geometry.o MotionControl_v6/geometry.cpp

${OBJECTDIR}/MotionControl_v6/goto_point.o: MotionControl_v6/goto_point.cpp
	${MKDIR} -p ${OBJECTDIR}/MotionControl_v6
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MotionControl_v6/goto_point.o MotionControl_v6/goto_point.cpp

${OBJECTDIR}/MotionControl_v6/kinematics.o: MotionControl_v6/kinematics.cpp
	${MKDIR} -p ${OBJECTDIR}/MotionControl_v6
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MotionControl_v6/kinematics.o MotionControl_v6/kinematics.cpp

${OBJECTDIR}/MotionControl_v6/main.o: MotionControl_v6/main.cpp
	${MKDIR} -p ${OBJECTDIR}/MotionControl_v6
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MotionControl_v6/main.o MotionControl_v6/main.cpp

${OBJECTDIR}/MotionControl_v6/path_control.o: MotionControl_v6/path_control.cpp
	${MKDIR} -p ${OBJECTDIR}/MotionControl_v6
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MotionControl_v6/path_control.o MotionControl_v6/path_control.cpp

${OBJECTDIR}/MotionControl_v6/pwm.o: MotionControl_v6/pwm.cpp
	${MKDIR} -p ${OBJECTDIR}/MotionControl_v6
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MotionControl_v6/pwm.o MotionControl_v6/pwm.cpp

${OBJECTDIR}/MotionControl_v6/qei.o: MotionControl_v6/qei.cpp
	${MKDIR} -p ${OBJECTDIR}/MotionControl_v6
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MotionControl_v6/qei.o MotionControl_v6/qei.cpp

${OBJECTDIR}/MotionControl_v6/relative_rotation.o: MotionControl_v6/relative_rotation.cpp
	${MKDIR} -p ${OBJECTDIR}/MotionControl_v6
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MotionControl_v6/relative_rotation.o MotionControl_v6/relative_rotation.cpp

${OBJECTDIR}/MotionControl_v6/speed_control.o: MotionControl_v6/speed_control.cpp
	${MKDIR} -p ${OBJECTDIR}/MotionControl_v6
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MotionControl_v6/speed_control.o MotionControl_v6/speed_control.cpp

${OBJECTDIR}/MotionControl_v6/timers.o: MotionControl_v6/timers.cpp
	${MKDIR} -p ${OBJECTDIR}/MotionControl_v6
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MotionControl_v6/timers.o MotionControl_v6/timers.cpp

${OBJECTDIR}/libs/controllib/chebyshev.o: libs/controllib/chebyshev.cpp
	${MKDIR} -p ${OBJECTDIR}/libs/controllib
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/libs/controllib/chebyshev.o libs/controllib/chebyshev.cpp

${OBJECTDIR}/libs/controllib/low_pass.o: libs/controllib/low_pass.cpp
	${MKDIR} -p ${OBJECTDIR}/libs/controllib
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/libs/controllib/low_pass.o libs/controllib/low_pass.cpp

${OBJECTDIR}/libs/controllib/periodic_task.o: libs/controllib/periodic_task.cpp
	${MKDIR} -p ${OBJECTDIR}/libs/controllib
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/libs/controllib/periodic_task.o libs/controllib/periodic_task.cpp

${OBJECTDIR}/libs/controllib/pid.o: libs/controllib/pid.cpp
	${MKDIR} -p ${OBJECTDIR}/libs/controllib
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/libs/controllib/pid.o libs/controllib/pid.cpp

${OBJECTDIR}/libs/timer/SoftTimer.o: libs/timer/SoftTimer.cpp
	${MKDIR} -p ${OBJECTDIR}/libs/timer
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/libs/timer/SoftTimer.o libs/timer/SoftTimer.cpp

${OBJECTDIR}/libs/timer/main.o: libs/timer/main.cpp
	${MKDIR} -p ${OBJECTDIR}/libs/timer
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/libs/timer/main.o libs/timer/main.cpp
